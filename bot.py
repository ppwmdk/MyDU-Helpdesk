...
def build_application() -> Application:
    ...
    application.add_handler(CommandHandler("staff_menu", staff_menu))
    application.add_handler(CommandHandler("list_reports", list_reports))
    application.add_handler(CommandHandler("report_by_id", report_by_id))
    application.add_handler(CommandHandler("filter_module", filter_module))
    application.add_handler(CommandHandler("set_status", set_status))
    application.add_handler(CommandHandler("take_report", take_report))
    application.add_handler(CommandHandler("resolve_report", resolve_report))
    application.add_handler(CommandHandler("export_excel", export_excel))
    application.add_handler(CommandHandler("backup", backup_command))

    application.add_handler(MessageHandler(filters.Regex("^Последние заявки$"), staff_button_router))
    application.add_handler(MessageHandler(filters.Regex("^Выгрузить Excel$"), staff_button_router))
    application.add_handler(MessageHandler(filters.Regex("^Backup базы$"), staff_button_router))
    application.add_handler(MessageHandler(filters.Regex("^Скрыть меню$"), staff_button_router))
